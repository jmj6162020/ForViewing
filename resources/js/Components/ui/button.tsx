...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus:ring-2 focus:ring-cobalt-800 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-gray-300',
  {
    variants: {
      variant: {
        default:
          'bg-cobalt-800 text-white hover:bg-cobalt-800/90 active:bg-cobalt-900',
        destructive:
